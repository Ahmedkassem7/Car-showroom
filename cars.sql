...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2023 at 11:03 PM
...
INSERT INTO `admin` (`id`, `Username`, `EmailAddress`, `Password`) VALUES
(1, 'admin', 'admin@gmai.com', 'admin'),
(2, 'ahmed', 'ahmedsanad@gmail.com', '123');
...
(10, 'aa', 11, 11, 11, 112),
(11, '123123', 123213, 123123, 123213, 1232),
(12, 'hfgdjxdgujcf', 2147483647, 34, 44, 444),
(13, 'adham', 2147483647, 65, 44, 128),
(14, 'ahmed ', 12312313, 123, 11, 311);
...
(1, 'Dodge', 2300000, 'Dodge Charger Supercharged 6.2L HEMI® High-Output SRT® V8Engine with 797 HP and 707 LB-FT of TorqueThe Most Powerful and Fastest Mass ProducedSedan®Customizable Build Configurations and ExclusiveOptions', 'cars_img/1.png', 'cars_img/2.png', 'cars_img/3.png'),
...
(1746, 'ndmxdmv', 368468, 'jfhgjkjkl;jhg', 'cars_img/5.png', 'cars_img/7.png', 'cars_img/2.png');
...
(10, 'adel', 'adel@gmail.com', '123123', '123123');
...
--
ALTER TABLE `cars`
  MODIFY `ID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1747;
